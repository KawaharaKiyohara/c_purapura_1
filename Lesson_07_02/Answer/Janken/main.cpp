...
// ここから関数定義を書いていってね。
///////////////////////////////////////////////////////////////////
void ComNoTeWoKettei( int& com )
{
	//COMの手をランダムに決定。
	com = rand() % 3;	//0がグー、１がチョキ、２がパー。
}

void InputPlayerNoTe( int& player, int battleCount )
{
	//ここからプレイヤーの手を入力させる。
...
void DrawPlayerNoTe( int player )
{
	//プレイヤーの手を表示。
	if (player == 0) {
		cout << "プレイヤーの手はグー。\n";
...
void DrawAndCountUpJankenResult(
	int player, 
	int com, 
	int& playerWinCount, 
	int& comWinCount, 
...
int main()
{
	...
	while (true) {
		...
		//			  例) InputPlayerNoTe
		//////////////////////////////////////////////////////////////////////////////
		InputPlayerNoTe( player, battleCount );
		...
		//			例) DrawJankenSenseki
		//////////////////////////////////////////////////////////////////////////////
		DrawJankenSenseki(battleCount, playerWinCount, comWinCount, evenCount );
	}
